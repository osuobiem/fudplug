<div class="modal fade" id="single-post-modal" tabindex="-1" data-backdrop="static" role="dialog"
    aria-labelledby="modalLabel" aria-hidden="true">
    <i class="la la-times-circle la-lg post-ico py-1"></i>
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <!-- Post -->
                <div class="box border rounded bg-white mb-3 osahan-post" id="post__{{ $post->id }}">
