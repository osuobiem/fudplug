<header>
	<div class="container">
		<!-- Mobile Header -->
		<div class="header-data d-block d-md-none">
		...
		<!-- Desktop Header -->
		<div class="header-data d-none d-md-flex">
			<div class="logo">
				<a href="index.html" title=""><img src="{{ url('assets/images/logo.png') }}" alt="" /></a>
			</div>
			<!--logo end-->
                                ...
                                <div class="notfication-details">
                                    <div class="noty-user-img">
                                        <img
                                            src="{{
                                                url(
                                                    'assets/images/resources/ny-img2.png'
                                                )
                                            }}"
								alt=""
								/>
...
<!-- Mobile Bottom Menu -->
<div class="header-data d-block d-md-none mobile-bottom">
