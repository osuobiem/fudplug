<div class="modal fade" id="order-detail-modal" tabindex="-1" data-backdrop="static" role="dialog"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-1">
                        <button type="button" style="font-size: 15px;" onclick="showContact(this)"
                            ...
                            Contact</button>
                        <a type="button" href="tel:{{$order->phone}}" style="font-size: 15px; margin-top: 0px;"
                            id="contact-btn" class="btn btn-success btn-block d-none">{{$order->phone}}</a>
                    </div>
                </div>
            </div>
        </div>
