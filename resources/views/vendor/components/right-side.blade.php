<aside class="col col-lg-3 d-none d-lg-block side-section side-section-r">
    <div class="box shadow-sm border rounded bg-white mb-3">
        <ul class="nav border-bottom box-title d-flex justify-content-center osahan-line-tab" id="myTab" role="tablist">
            ...
            <li class="nav-item border-left col-md-6">
                <a class="nav-link text-center" id="home-tab" data-toggle="tab" href="#dish" role="tab"
                    aria-controls="home" aria-selected="false">Dishes</a>
            </li>
        </ul>
