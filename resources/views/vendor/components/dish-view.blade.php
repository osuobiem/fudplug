    ...
    <div class="container" id="view" role="tabpanel" aria-labelledby="profile-tab">
        <div class="row shadow rounded">
            <div class="img-container pl-md-0 col-md-7">
                <img id="image" class="img-edit rounded" src="{{Storage::url('vendor/dish/'.$dish->image)}}">
            </div>
            @if($dish->type == "simple")
            <div class="col-md-5">
                <div>
                    ...
                    <div class="mb-5 pt-3 text-lg-left text-center">
                        ...
                        <div class="float-right nav">
                            <a class="text-dark" id="edit-btn"><i class="la la-pen la-2x icon-hover pt-0"></i></a>
                        </div>
                    </div>
                            ...
                            <div>
                                <h5 class="mb-0">
                                    <button
                                        ...
                                        data-toggle="" data-target="" aria-expanded="false" aria-controls="">
                                        Regular Quantity
    ...
    <div class="container" id="form">
        <form id="update-dish" enctype="multipart/form-data">
            ...
            <div class="row border rounded pt-2 mt-2 shadow-sm mb-2 bg-white">
                ...
                <div class="col-sm-6 col-xs-6 mb-2">
                    <input class="form-control" name="price" type="number" placeholder="Price" value="{{$price}}"
                        required />
                </div>
                <div class="col-sm-6 col-xs-6 mb-2">
                ...
                <div class="input-group-btn col-sm-12 my-2">
                    <a class="btn btn-secondary" id="back-btn" role="tab" aria-controls="home" aria-selected="true"><i
                ...
                <div class="col-sm-6 border pt-2 pb-3">
                    ...
                    <div>
                        ...
                        <div class="mb-2 form-inline">
                            <input class="form-control rounded-right-0 col-sm-4 one" name="regular_title[]" type="text"
                                value="{{$qty->title}}" placeholder="Max-pack" required />
                            <input class="form-control col-sm-4 rounded-0 one" name="regular_price[]" type="number"
                                value="{{$qty->price}}" placeholder="1000" required />
                            <input class="form-control rounded-left-0 col-sm-4 one" name="regular_quantity[]"
                                type="text" value="{{$qty->quantity}} {{$qty->qty_title}}" placeholder="20 Plates"
                                required />
                        </div>
                        @endforeach
                        @else
                    ...
                    <div>
                        ...
                        <div class="bulk-entry-1 mb-2 form-inline">
                            <input class="form-control col-sm-4 rounded-right-0" name="bulk_title[]"
                                value="{{$qty->title}}" step="0.01" type="number" placeholder="2.5" required />
                            <input class="form-control col-sm-4 rounded-left-0 rounded-right-0" name="bulk_price[]"
                                type="number" value="{{$qty->price}}" placeholder="1000" required />
                            <input class="form-control col-sm-4 rounded-left-0 init" name="bulk_quantity[]"
                                value="{{$qty->quantity}}" type="number" placeholder="10" required />
