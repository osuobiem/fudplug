...
<div class="box shadow-lg border rounded bg-white mb-3">
        ...
        <div class="row">
            <div class="col-12 p-2">
                ...
                <div class="form-check float-right">
                    <input class="form-check-input" type="checkbox" onchange="checkAll(this)" id="defaultCheck1">
                ...
                <li class="list-group-item">
                    <div class="d-flex align-items-center osahan-post-header people-list">
                        ...
                        <div class="ml-auto">
                            ...
                            <input class="" name="item[]" type="checkbox" onchange="state(this)" value="{{$dish->id}}"
                                id="defaultCheck{{$dish->id}}" checked>
                            <label class="form-check-label" for="defaultCheck{{$dish->id}}">
                                Remove
                            </label>
                            @else
                            <input class="" name="item[]" type="checkbox" onchange="state(this)" value="{{$dish->id}}"
                                id="defaultCheck{{$dish->id}}">
                            <label class="form-check-label" for="defaultCheck{{$dish->id}}">
                                Select
                            </label>
                            @endif
    ...
    <div class="form-group text-center col-sm-12 mb-3 m-0">
        <button id="menu-update-btn" class="btn btn-primary px-5">
            ...
            <div class="spinner-border spinner-border-sm btn-pr" id="menu-update-spinner" style="display: none;"
                role="status">
