...
<div id="basicsAccordion">
    <div class="box shadow border rounded bg-white mb-2">
                ...
                <a href="javascript:void(0)" onclick="toggleAccordion(event, this)" type="button"
                    ...
                    <div class="media">
                        <div class="u-avatar mr-3">
                            <img class="img-fluid rounded-circle" src="/storage/vendor/dish/{{$dish->image}}"
        ...
        <div id="basicsCollapseOne" class="collapse @if($dish_key < 1): show @endif" aria-labelledby="basicsHeadingOne"
                    ...
                    <li class="list-group-item pt-0">
                        ...
                        <div class="float-right col-2">
                            <a href="javascript:void(0)" title="delete"
                                onclick="deleteCartItem(this, '{{$dish->id}}', '{{$dish->order_type}}')">

                                <i class="las la-trash-alt mt-4 bskt-del-btn" id="basket-delete-{{$dish->id}}-txt"></i>
                                <div class="spinner-border spinner-border-sm mt-4 btn-pr"
                                    id="basket-delete-{{$dish->id}}-spinner" style="display: none;" role="status">
                        ...
                        <div class="float-right col-5 mt-4">
                            <div class="input-group qty-field">
                                ...
                                <input type="text" name="order_quantity[]" onkeydown="keydown(event)"
                                    ...
                                    value="{{$order_qty}}" min="0" max="{{$actual_detail['quantity']}}" disabled>
                                <span class="input-group-btn">
                        ...
                        <div class="float-left col-4">
                            <div class="text-left">
                                ...
                                <input class="basket-price" name="basket_price[]" type="hidden"
                                    value="{{$qty['price']}}">
                                <input name="order_detail[]" type="hidden" value="['regular','{{$key}}']" disabled>
                            </div>
                        </div>
                        <div class="float-right col-2">
                            <a href="javascript:void(0)"
                                onclick="deleteCartItem(this, '{{$dish->id}}', '{{$dish->order_type}}', '{{$key}}')">
