<!-- MOBILE VIEW -->
<div class="modal fade" id="user-profile-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                    <div class="py-3 px-3 border-bottom">
                        ...
                        <div class="mt-5">
                            <h5 class="font-weight-bold text-dark mb-0 mt-2">{{Auth::guard('user')->user()->name}}
                            </h5>
                    ...
                    <div class="overflow-hidden border-top">
                        <a class="font-weight-bold p-3 d-block" onclick="showMobileEdit()" href="#"> Edit my
                            profile </a>
                    </div>
                </div>
            </div>
